...
# Raspberry Pi GPIO MIDI Buzzer
# Version 1.3, (c) 2019-2020 Freddy F.  License: DWTFYW
...
A=448 # you can change this if you want to re-pitch
midi_note_to_freq = []
import math
...
print "GPIO MIDI Buzzer (c) 2019-2020 Freddy F.  License: DWTFYW"
if len(sys.argv)<2:
    print "Syntax: python midi-buzzer.py MIDI-filename ..."
